<template>
  <div ref="preContainerRef" class="wrapper">
    <div
      ref="containerRef"
...
const preContainerRef = ref<HTMLElement | null>(null)

// SVG 内容
const svgContent = `<svg viewBox="0 0 446 540" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-linejoin="round" stroke-miterlimit="2" class="illustration">
<defs>
...
<g id="scene">
    ...
    <g id="tri-wave1" fill="#2ec3ec">
        <path d="M366.29 502.93a1.27 1.27 0 012.04 0l21.55 29.42a1.27 127 0 01-1.03 2.02h-43.27a1.27 1.27 0 01-1.01-2.02l21.72-29.42z"></path>
...
let script3: HTMLScriptElement | null = null
...
onMounted(() => {
  ...
  containerRef.value.appendChild(script1)

  script2 = document.createElement('script')
  script2.textContent = motionPathPlugin
  containerRef.value.appendChild(script2)

  script3 = document.createElement('script')
  script3.textContent = animationScript
  containerRef.value.appendChild(script3)
})
...
watch(
  () => props.active,
  (val) => {
    if (!preContainerRef.value || !containerRef.value) return
